...
class DebuggingScenariosTest {
  ...
  void nonPrimitiveCollectionTest() {
    ...
    final CollectionHolder<Material> materialHolder =
        new CollectionHolder<>(
            Lists.newArrayList(
                Material.create("1", 10), Material.create("2", 20), Material.create("3", 30)));
  ...
  void nonPrimitiveCollectionAtRootTest() {
    // Lists work even with objects
    final List<Material> materialsList =
        Lists.newArrayList(
            Material.create("1", 10), Material.create("2", 20), Material.create("3", 30));
    ...
    System.out.println(materialsList);
    // Lists work even with objects
    final Set<Material> materialsSet =
        Sets.newHashSet(
            Material.create("1", 10), Material.create("2", 20), Material.create("3", 30));
  ...
  @NotNull private static Product makeProductWith2Mats() {
    final Material mat1 = Material.create("123", 2);
